        ...
        <div class="jumbotron jumbotron-fluid bg-success h-25">
          <div class="d-flex justify-content-end">
            <a href="login.html" class="btn btn-primary">Voltar</a>
              ...
              <h1 class="mt-4 text-center text-light" >Gestão - Produto</h1>
        </div>
        ...
        <div class="modal-body">
            <form>
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control input_user" placeholder="Produto">
                </div>
                <div class="input-group mb-3">
                    <div class="input-group-append">
                        <span class="input-group-text"><i class="fas fa-user"></i></span>
                    </div>
                    <input type="text" class="form-control input_user" placeholder="Descrição">
                </div>
                <div class="input-group mb-2">
                    <div class="input-group-append">
                        <span class="input-group-text"><i class="fas fa-sort-amount-up"></i></span>
                    </div>
                    <input type="text" name="" class="form-control input_pass" value="" placeholder="00">
                </div>
                <div class="input-group mb-2">
                    <div class="input-group-append">
                        <span class="input-group-text"><i class="far fa-money-bill-alt"></i></span>
                    </div>
                    <input type="password" name="" class="form-control input_pass" value="" placeholder="R$ 0,00">
                </div>
